...
const Navbar = () => {
  const { activeMenu, setActiveMenu, isClicked, setIsClicked, handleClick,
    screeSize, setScreeSize } = useStateContext();

  useEffect(() => {
    const handleResize = () => setScreeSize
      (window.innerWidth);
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 realative'>
      <NavButton
        title='Menu'
        ...
        >
          <div className='flex items-center gap-2 cursor-pointer p-1hover:bg-light-gray rounded-lg'
            ...
            <p>
              ...
              <span className='text-gray-400 text-14'>Cristian</span> {' '}
            </p>
            <MdKeyboardArrowDown
